...
# Access
acces_token='1152350884161966081-AYoFdBUsiTm3XkYb2kIR08pgUE5Rwx'
acces_token_secret='ngocFpCMLzsTLuwsJlwlU5zUbszo46ERmpXhTHrhjoN5X'

#Consumer
consumer_key='mdcHxFsxMLBSWU3Cygg3FVbXt'
consumer_secret='WCNhqArAHY2nU3dNcVAk2QxFf7vKstP57zXf3GSEyqqsWGUEmh'
...
def page_two(scr1):
    ...
    lab=Label(mainf2,text= "Created by Sandeep Yadav",fg="red",font=('Times New Roman',20,'bold'),bg='sky blue')
